...
[오전에는카페에서맛있는거먹으며나의일에집중](https://www.youtube.com/watch?v=6R7I7qUc90k)
![https://www.youtube.com/watch?v=6R7I7qUc90k](read_in_sunset.png)
...
#### 잠, 루틴
방에 잠에 대한 그림을 걸어놓아 잠의 중요성을 상기한다
자기전에 뭘 볼 필요가 없다
...
#### 쾌락을 원할 때를 알아야한다
- 그냥 재밌는거를 찾으려고 할 때 찾아갈 곳이 있어야 한다
- 침하하도 있는데 부족하다
- 유튜브도 끝이 없다
- 끝이 정해져있는 예능? 드라마? 근데 유튜브의 실시간성 현황이 궁금하긴 하다
- 실시간적인 트렌드 있는 재밌는거
- 유튜브 예능? 프로그램을 정해서 그거만 본다?
- 좋아하는걸 찾는다?
- 육아예능만 본다고 했을 때 그거만 보면 쾌락이 충족 안될거 같음
- 그렇다고 누가 나오는 뭔가를 보는게 충족이 될까
- 유튜브 1시간 보는걸로 충족이 안될까
- 근데 또 쾌락 충전하고 나면 다시 하고싶은걸 하게 된다
- 측정 장치만 잘 해두면 되지 않을까
- 목적 없이 뭔가를 하고 싶을 때를 제어해야 한다
	- 그 때 명상이 필요할까

- 모든 것은 멘탈에 달렸다. 정말로
- 명상은 실제로 효과가 있고 도움이 된다
- 속세를 다 버리고 떠나도 잡념이 사라지지 않았다고 한다

#### 하루하루는 흘러가게 하고 일주일 단위로 측정할 수 있게 한다
- 측정한 것을 토대로 하루하루의 흐름을 조금씩 조정한다
- 하루 한페이지씩 글쓰기를 해서 밤까지 쓰고 아침에 **디지털로 전환**한다
	- 전환이 머리에 남는다
...
#### 일정이 있는 날 되도록 몰고 비는 날은 싹 비워서 도서관이나 카페에 가신다
범준교수님 유튜브에서 발췌

## 데일리 리뷰 시스템

하루 헤드라인은 꼭 남기기
- 거기에 더해 쓰레드를 쓸 수 있으면 베스트
- 매일 10분 회고해서 글을 쓸 수 있으면 그걸로 충분하지 않을까
- pdca 기반으로
- 회고랑 가설기반 진행이랑 별개긴 하다
- 여행의 경험도 계속 증가시켜 나가야한다
- 주말에 그걸 모아 영상 하나 만들고
- 한달에 롱폼 하나 만들고
...
1. 데일리로 아카이브에 쓴다
2. 한장으로 끝낸다
3. 계획 대비 결과와 내일 반영할 개선점만 넣는다
4. 타임라인으로 구글타임라인이랑 스크린타임, 소비기록만 넣는다
5. AI로 한번만 다듬는다
6. 밤에 다음날 계획은 해놓고 다음날 비교하면 좋다

- 근데 이걸 해서 내가 뭘 얻으려는거지
	- 내일 반영할 개선점이 잘 만들어졌는지. 일과가 어땠는지. 오늘을 잘 돌아봤는지. 
	- 헤드라인은 뭘 했는데 왜 했는지
	- 본문은 계획대비 실행을 뭘 했는지
	- 개선점은 본문에서 배운점
	- 하기로 한 것과 실제로 한 것의 간극을 메운다
	- 하루의 계획과 실제 일과 비교
	- 계획이 가설이고 실제가 결과다
...
- 매일 쓸 수 있게 최소 체크리스트만 잡기
	- 독자 입장
	- 한가지 주제
	- 첫 문장 후킹

밤에 내 노트에서 추천질문 뽑아서 3개 주면서 데일리 리뷰 하라고 하면 내가 매일 할까
- 돈 쓴거도 같이 내역에 나오게 하면 볼까
- 내가 보고 싶은 내용이 있어야함

4시간 몰입, 나머지는 그 시스템 만들기를 위한 독서, 문화생활, 일상에서의 영감

오전에 리포트를 받고 저녁에는 마무리 흐름만 받기가 나의 사이클과 맞다
