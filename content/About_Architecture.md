...
updated : 2021-09-18 01:08:44 +0900
tags    : develop
---
...
## 기업들이 데브옵스 채용 후의 상황 변화된 사례나 데브옵스들의 경험담을 보고 싶다
...
#### kakao api question
자전거 배치 서비스를 하게 되면
자전거 위치에 대한 구조체와 트럭의 상태에 대한 구조체가 있어야 한다.
비즈니스 로직의 기본 틀인데,
이것을 레고로 만들겠다고 다 추상화해버리면 안된다.
