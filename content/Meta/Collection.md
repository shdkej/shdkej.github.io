...
- 로컬에서만 가능한 것 모으기
	- 큰 파일 처리 (영상작업)
	- 생성된 파일 처리 - 이건 git이 어느정도 해줌, 안되면 드라이브 연동도 되는데 상황 확인
...
#### 좋은 대사 10개를 간직하자
- 타오르는 여인의 초상
- 김한주님의 말 - https://www.youtube.com/watch?v=Q6B7vIyA01U
- 프렌즈
- 말줄임표
- 최강록
- 스물다섯 스물하나
...
#### 운동선수의 훈련법과 개발자의 훈련법
운동선수나 가수는 하나의 완결된 것을 수없이 반복해야 한다.
이것은 나에게 매우 힘든 일이다.
예술가들은 어떻게 훈련하는가
