...
1. Kubernetes를 Cloud에서 호스팅한다
	- 비용이 월 10만원 이상 들게 된다
	- 무산
2. Digital Ocean의 관리형 Kubernetes를 쓴다
	- 사양이 낮으면 서비스가 제대로 돌지 않는다
	- 무산
3. Oracle Cloud에 무료 ARM 고사양 서버가 제공된다
...
- [x] golang으로 api 서버 만들어서 telegram 보내는 것도 등록 ✅ 2026-05-22
...
## 모니터링 셋업
- [x] GA4 커넥션 안정적으로 등록하기 ✅ 2026-05-24
- [x] 기본 모니터링 지표 다 수집되는지 확인 ✅ 2026-06-29