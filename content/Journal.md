...
updated : 2021-09-17 21:12:27 +0900
tags    : idea
---
...
wiki is fit to me.
- wiki can make evolve documentation. it is what I want. Evolving is my way.

Day drive by note.
- But I want to know live news
- Receive live news from my source.
- To improve my knowledge. I should have know what I wanted to know.
- Now I have so many stucked Idea.
...
- 위젯
- 마크다운
- 빅스비 버튼 클릭시 화면 꺼진상태에서 바로 켜지는 메모앱 만들기
- 일일이 클릭하기 귀찮다
...
#### 인프라를 개선 시킬 파이프라인 만들기
순환하는 파이프라인을 만들어서 개발하면서 인프라도 자동화하는 일석이조 노리기

개발하다보면 한번씩 걸리는 부분이 생긴다. 근데 그 문제를 처리하고 다시 개발로
돌아오기는 힘들다.
그리고 개발은 끝이 없이 계속 이어지기 때문에 결국 그 문제는 계속 남게 된다.
...
#### history
- 제목을 영어로만 쓰다가 태그처럼 검색되게 하기 위해 한글을 보이도록 했다
